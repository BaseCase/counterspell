...
var G__19762 = o;
reagent.impl.template.goog$module$goog$object.set(G__19762,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
var G__19763 = o;
reagent.impl.template.goog$module$goog$object.set(G__19763,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__19784__i < G__19784__a.length) {G__19784__a[G__19784__i] = arguments[G__19784__i + 0]; ++G__19784__i;}
  args = new cljs.core.IndexedSeq(G__19784__a,0,null);
} 
...
var G__19764 = props;
var G__19764__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19764,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__19764);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19764__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__19765 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__19765,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__19765;
}
})(),id_class);
...
var G__19766 = (cljs.core.count(argv) - first_child);
switch (G__19766) {
case (0):
...
var vec__19767 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19767,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19767,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19767,(2),null);
...
var temp__5808__auto___19793 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19793 == null)){
} else {
var key_19794 = temp__5808__auto___19793;
(jsprops.key = key_19794);
}
...
var temp__5808__auto___19795 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___19795 == null)){
} else {
var key_19796 = temp__5808__auto___19795;
(jsprops.key = key_19796);
}
...
var temp__5808__auto___19797 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___19797 == null)){
} else {
var key_19798 = temp__5808__auto___19797;
(jsprops.key = key_19798);
}
...
var temp__5808__auto___19801 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19801 == null)){
} else {
var key_19802 = temp__5808__auto___19801;
(jsprops.key = key_19802);
}
...
var temp__5808__auto___19805 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___19805 == null)){
} else {
var key_19806 = temp__5808__auto___19805;
(jsprops.key = key_19806);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19770_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__19770_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__19771 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19771,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19771,(1),null);
...
break;
default:
var G__19809 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__19810 = compiler;
v = G__19809;
compiler = G__19810;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template19777 = (function (opts,id,fn_to_element,parse_fn,meta19778){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template19777.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19779,meta19778__$1){
var self__ = this;
var _19779__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template19777(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta19778__$1));
}));

(reagent.impl.template.t_reagent$impl$template19777.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19779){
var self__ = this;
var _19779__$1 = this;
return self__.meta19778;
}));

(reagent.impl.template.t_reagent$impl$template19777.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template19777.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template19777.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template19777.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template19777.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template19777.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta19778","meta19778",-1442668334,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template19777.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template19777.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template19777");

(reagent.impl.template.t_reagent$impl$template19777.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template19777");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template19777.
 */
reagent.impl.template.__GT_t_reagent$impl$template19777 = (function reagent$impl$template$__GT_t_reagent$impl$template19777(opts,id,fn_to_element,parse_fn,meta19778){
return (new reagent.impl.template.t_reagent$impl$template19777(opts,id,fn_to_element,parse_fn,meta19778));
});
...
return (new reagent.impl.template.t_reagent$impl$template19777(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
