...
var i_19562 = (self__.level + (1));
while(true){
if((i_19562 <= (new_level + (1)))){
(update[i_19562] = self__.header);

var G__19566 = (i_19562 + (1));
i_19562 = G__19566;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_19569 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_19569[i]));
} else {
x__$2.forward.push((((i < links_19569.length))?(links_19569[i]):null));
}

if((i < links_19569.length)){
(links_19569[i] = x__$2);
} else {
links_19569.push(x__$2);
}
...
var i_19600 = (0);
while(true){
if((i_19600 <= self__.level)){
var links_19602 = (update[i_19600]).forward;
if((x__$1 === (((i_19600 < links_19602.length))?(links_19602[i_19600]):null))){
(links_19602[i_19600] = (x__$1.forward[i_19600]));

var G__19606 = (i_19600 + (1));
i_19600 = G__19606;
continue;
} else {
var G__19609 = (i_19600 + (1));
i_19600 = G__19609;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__19649 = nx;
var G__19650 = (level__$1 - (1));
x = G__19649;
level__$1 = G__19650;
continue;
} else {
var G__19653 = x;
var G__19654 = (level__$1 - (1));
x = G__19653;
level__$1 = G__19654;
continue;
}
